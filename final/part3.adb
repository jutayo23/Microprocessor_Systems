...
F:G$int0_interrupt$0$0({2}DF,SV:S),C,0,0,1,0,0
...
S:Lpart3.main$analogval$1$28({2}SI:U),E,0,0
S:Lpart3.main$analoghi$1$28({3}DG,SC:U),R,0,0,[]
S:Lpart3.main$analoglow$1$28({3}DG,SC:U),R,0,0,[]
S:Lpart3.main$VREF$1$28({4}SF:S),R,0,0,[]
S:Lpart3.main$result$1$28({4}SF:S),E,0,0
S:Lpart3.main$result_high$1$28({2}SI:S),R,0,0,[]
S:Lpart3.main$result_low$1$28({2}SI:S),R,0,0,[]
S:Lpart3.main$samples$1$28({1}SC:S),R,0,0,[]
S:Lpart3.main$accum$1$28({32}DA16d,SI:S),E,0,0
S:Lpart3.main$i$1$28({1}SC:S),E,0,0
S:Lpart3.main$sum$1$28({4}SL:U),R,0,0,[]
S:Lpart3.main$avg$1$28({2}SI:U),E,0,0
S:Lpart3.main$result_dec1$1$28({4}SF:S),E,0,0
S:Lpart3.main$result_dec2$1$28({4}SF:S),E,0,0
...
S:G$int0_interrupt$0$0({2}DF,SV:S),C,0,0
